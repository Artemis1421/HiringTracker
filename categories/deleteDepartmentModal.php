<div class="modal fade" id="deleteDepartment" tabindex="-1" aria-labelledby="deleteDepartmentLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body container">
                <form method="post" action="department_validation.php">
                    ...
                    <div class="d-none">
                        ...
                        <input type="text" required class="form-control" id="delete_department_id" name="d_id">
                    </div>
            </div>
            <div class="modal-footer d-flex justify-content-center my-2">
                ...
                <button type="submit" class="btn btn-payreto-darkblue-900 mx-2" name="deleteDepartmentButton">Confirm</button>
            </div>
        </div>
    </div>
</div>